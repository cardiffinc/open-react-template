...
const CorporateEvents = () => {
  ...
  return (
    <section className="bg-gray-900 text-white">
      {/* Hero Section */}
      <div className="relative bg-gray-900 text-white text-center py-20 px-6" data-aos="fade-up" >
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4">
          Turn Corporate Events into <span className="text-purple-500 block">Unforgettable Experiences</span>
        </h1>
        <p className="mt-4 text-2xl md:text-3xl mx-auto font-bold">
          Let’s JAM!
        </p>
      ...
      {/* Story Section */}
      <div className="max-w-5xl mx-auto py-16 px-6 space-y-6 text-center" data-aos="fade-up">
        <p className="text-lg">
      ...
      <div className="bg-gray-700 py-12" data-aos="fade-up">
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <p className="mt-2 text-gray-300">Live Gigs Curated</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-purple-600">50+</h3>
            <p className="mt-2 text-gray-300">Venues Partnered</p>
          </div>
          <div>
            <h3 className="text-3xl font-bold text-purple-600">150+</h3>
            <p className="mt-2 text-gray-300">Artists in Our Network</p>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-6 max-w-5xl mx-auto text-center" data-aos="fade-up">
        <h2 className="text-3xl font-bold mb-4">Why Music for Corporates?</h2>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {['Employee Engagement', 'Brand Activation', 'Culture Building'].map((item) => (
            <div key={item} className="bg-white shadow rounded-lg p-6 text-purple-600 font-semibold">
              {item}
            </div>
          ))}
        </div>
      ...
      {/* Services Section */}
      <div className="bg-gray-800 py-20 px-6" data-aos="fade-up">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
            {[
              ...
              <div key={service.title} className="bg-white shadow-md rounded-lg p-6">
