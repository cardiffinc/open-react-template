          ...
          <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-slate-500 inline-flex">
              <a
                ...
                href="https://github.com/BlrGrooveCo/open-react-template"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a className="font-medium hover:underline text-emerald-400" href="https://BlrGrooveCo.com/open-pro/" target="_blank" rel="noreferrer">
